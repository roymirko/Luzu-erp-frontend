...
function mapFromDBWithContext(row: ComprobanteFullRow): ComprobanteWithContext {
  return {
    ...
    // Tecnica
    tecnicaComprobanteId: row.tecnica_comprobante_id ?? undefined,
    tecSector: row.tec_sector ?? undefined,
    tecRubro: row.tec_rubro ?? undefined,
    tecSubRubro: row.tec_sub_rubro ?? undefined,
    tecNombreCampana: row.tec_nombre_campana ?? undefined,
    tecUnidadNegocio: row.tec_unidad_negocio ?? undefined,
    tecCategoriaNegocio: row.tec_categoria_negocio ?? undefined,
    tecOrdenPublicidad: row.tec_orden_publicidad ?? undefined,
    tecOrdenPublicidadId: row.tec_orden_publicidad_id ?? undefined,
    // Programacion
    ...
    progRubro: row.prog_rubro ?? undefined,
    progSubRubro: row.prog_sub_rubro ?? undefined,
    // Experience
    ...
    expRubro: row.exp_rubro ?? undefined,
    expSubRubro: row.exp_sub_rubro ?? undefined,
